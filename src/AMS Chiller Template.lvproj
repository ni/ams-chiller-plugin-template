...
AddOutputFilter chunkFilter
		...
		<Item Name="gRPC" Type="Folder">
			...
			<Item Name="Custom" Type="Folder">
				<Item Name="AMSChillerTemplateService_client.lvlib" Type="Library" URL="../Plugin/Custom gRPC/AMSChillerTemplateService_client/AMSChillerTemplateService_client.lvlib"/>
				<Item Name="AMSChillerTemplateService_server.lvlib" Type="Library" URL="../Plugin/Custom gRPC/AMSChillerTemplateService_server/AMSChillerTemplateService_server.lvlib"/>
			</Item>
			<Item Name="Client Wrapper APIs" Type="Folder">
				...
				<Item Name="Plug-in Specific" Type="Folder">
					<Item Name="AMSChillerTemplateService_Client_Wrapper.lvlib" Type="Library" URL="../Plugin/Custom gRPC/AMSChillerTemplateService_Client_Wrapper/AMSChillerTemplateService_Client_Wrapper.lvlib"/>
				</Item>
			</Item>
		</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="LV Config Read String.vi" Type="VI" URL="/&lt;resource&gt;/dialog/lvconfig.llb/LV Config Read String.vi"/>
			<Item Name="Chiller.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/AMS plugin/Capabilities/Capabilities/High Level Capabilities/Chiller/Chiller.lvclass"/>
			<Item Name="Apply Gradient.vi" Type="VI" URL="/C/Program Files/National Instruments/AMS plugin/Chiller/Apply Gradient.vi"/>
			...
			<Item Name="Error Channels.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/AMS plugin/Capabilities/Capabilities/Low Level Capabilities/Error Channels/Error Channels.lvclass"/>
			...
			<Item Name="Pressure Actual Value.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/AMS plugin/Capabilities/Capabilities/Low Level Capabilities/Pressure/Pressure Actual Value/Pressure Actual Value.lvclass"/>
			<Item Name="Pressure Gradient.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/AMS plugin/Capabilities/Capabilities/Low Level Capabilities/Pressure/Pressure Gradient/Pressure Gradient.lvclass"/>
			<Item Name="Pressure Limit.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/AMS plugin/Capabilities/Capabilities/Low Level Capabilities/Pressure/Pressure Limit/Pressure Limit.lvclass"/>
			<Item Name="Pressure Setpoint.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/AMS plugin/Capabilities/Capabilities/Low Level Capabilities/Pressure/Pressure Setpoint/Pressure Setpoint.lvclass"/>
			<Item Name="Flow Setpoint.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/AMS plugin/Capabilities/Capabilities/Low Level Capabilities/Flow/Flow Setpoint/Flow Setpoint.lvclass"/>
			<Item Name="Flow Limit.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/AMS plugin/Capabilities/Capabilities/Low Level Capabilities/Flow/Flow Limit/Flow Limit.lvclass"/>
			<Item Name="Flow Gradient.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/AMS plugin/Capabilities/Capabilities/Low Level Capabilities/Flow/Flow Gradient/Flow Gradient.lvclass"/>
			<Item Name="Flow Actual Value.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/AMS plugin/Capabilities/Capabilities/Low Level Capabilities/Flow/Flow Actual Value/Flow Actual Value.lvclass"/>
			<Item Name="Control Mode.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/AMS plugin/Capabilities/Capabilities/Low Level Capabilities/Control Mode/Control Mode.lvclass"/>
			<Item Name="Output Enable.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/AMS plugin/Capabilities/Capabilities/Low Level Capabilities/Output Enable/Output Enable.lvclass"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="AMS Chiller Template" Type="Packed Library">
				...
				<Property Name="Bld_buildSpecName" Type="Str">AMS Chiller Template</Property>
				...
				<Property Name="TgtF_fileDescription" Type="Str">AMS Chiller Template</Property>
				<Property Name="TgtF_internalName" Type="Str">AMS Chiller Template</Property>
