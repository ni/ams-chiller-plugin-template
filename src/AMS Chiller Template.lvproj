...
AddOutputFilter chunkFilter
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="LV Config Read String.vi" Type="VI" URL="/&lt;resource&gt;/dialog/lvconfig.llb/LV Config Read String.vi"/>
			<Item Name="Chiller.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/BLS plugin/Capabilities/Capabilities/High Level Capabilities/Chiller/Chiller.lvclass"/>
			<Item Name="Apply Gradient.vi" Type="VI" URL="/C/Program Files/National Instruments/BLS plugin/Chiller/Apply Gradient.vi"/>
			...
			<Item Name="Tag Wrapper.lvlib" Type="Library" URL="../../git/adas-replay-hil-internal/source/Channels/Tag Wrapper/Tag Wrapper.lvlib"/>
			...
			<Item Name="Pressure Actual Value.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/BLS plugin/Capabilities/Capabilities/Low Level Capabilities/Pressure/Pressure Actual Value/Pressure Actual Value.lvclass"/>
			<Item Name="Pressure Gradient.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/BLS plugin/Capabilities/Capabilities/Low Level Capabilities/Pressure/Pressure Gradient/Pressure Gradient.lvclass"/>
			<Item Name="Pressure Limit.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/BLS plugin/Capabilities/Capabilities/Low Level Capabilities/Pressure/Pressure Limit/Pressure Limit.lvclass"/>
			<Item Name="Pressure Setpoint.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/BLS plugin/Capabilities/Capabilities/Low Level Capabilities/Pressure/Pressure Setpoint/Pressure Setpoint.lvclass"/>
			<Item Name="Flow Setpoint.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/BLS plugin/Capabilities/Capabilities/Low Level Capabilities/Flow/Flow Setpoint/Flow Setpoint.lvclass"/>
			<Item Name="Flow Limit.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/BLS plugin/Capabilities/Capabilities/Low Level Capabilities/Flow/Flow Limit/Flow Limit.lvclass"/>
			<Item Name="Flow Gradient.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/BLS plugin/Capabilities/Capabilities/Low Level Capabilities/Flow/Flow Gradient/Flow Gradient.lvclass"/>
			<Item Name="Flow Actual Value.lvclass" Type="LVClass" URL="/C/Program Files/National Instruments/BLS plugin/Capabilities/Capabilities/Low Level Capabilities/Flow/Flow Actual Value/Flow Actual Value.lvclass"/>
